    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm-3">
                ...
                <p>
                    Autism Social is a Site that is very concerned to Persons with Autism.
                </p>
            ...
            <div class="col-sm-3 mg25-xs">
                ...
                <p>
                    ...
                    <small class="address">Chrysanthemum Village, San Pedro, Laguna 4023</small>
                </p>
                <p>
                    <span class="ion-email footer-info-icons"></span>
                    <small class="address"><a href="mailto:info@autismsocial.ph">info@autismsocial.ph</a></small>
                </p>
                <p>
                    <span class="ion-ios7-telephone footer-info-icons"></span>
                    <small class="address">+639175029559</small>
                </p>
            </div>

            <!-- Recent Work -->
            <div class="col-sm-3 hidden-xs">
                <div class="heading-footer"><h4>Gallery</h4></div>
        ...
        <div class="row">
            ...
            <div class="col-sm-11 col-xs-10">
                <p class="copyright">© {{ date( 'Y' ) }} Autism Social PH. All rights reserved.</p>
            </div>
